...
from roms_info_db import load_roms_db

# %%

parser = argparse.ArgumentParser()
parser.add_argument("--dump-rom", type=str, default=None)
parser.add_argument("--dump-save", type=str, default=None)
parser.add_argument("--write-save", type=str, default=None)
